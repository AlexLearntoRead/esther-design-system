...
# Alex brand-dna 配置速查表（匹配现有插画色号）
画风style = 蜡笔手绘圆润卡通
线条规范 = 粗黑外轮廓、哑光粉笔肌理
# 品牌三色锁（与插画色块一一对应）
主蓝 #2B7FD8：女孩卷发/标题/链接/重点标记
暖金 #F4D758：女孩连衣裙/高亮/徽章/分割线
砖红 #E84A5F：红色小皮鞋/Alex品牌标识/按钮/标签下划线
# Alex标识硬性画面规则
载体：无，禁止添加发夹、卡扣、底板
摆放：人物画面右侧卷发区域
旋转角度：向右45°
字体：加粗圆润卡通字，色号固定#E84A5F
# IP人物固定上色设定（原图标准）
发型：蓬松大波浪卷发，填充#2B7FD8
服装：短袖直筒连衣裙，填充#F4D758
鞋子：平底单鞋，填充#E84A5F
面部：圆框眼镜、淡粉色腮红、简约微笑
背景：纯白纯色底，无杂色
# 品牌调性DNA
柔和、治愈、极简、儿童友好
# 硬性色彩限制
全视觉物料仅允许使用3种品牌色，色号不可修改；Alex文字与鞋子共用同一红色#E84A5F，画面色彩统一无偏差
